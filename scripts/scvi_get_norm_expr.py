...
parser.add_argument("-c", "--chunksize", default = None, type=int,  help = "Number of cells to compute expression values for at a time. Default: all the cells")
parser.add_argument("-n", "--n_samples", default = 10, type=int, help = "Number of posterior samples upon which to base predictions. Default: 10")
...
modeler = pmbscvi.ScviModeler(args.adata)
